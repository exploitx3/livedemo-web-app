...
const AIVoiceTab = ({voices, enhanceWithAIVoice, setShowConfetti, reloadStoryDemo, onCancel}) => {
  let [isLoading, setIsLoading] = useState(false)

  let [selectedVoice, setSelectedVoice] = useState({
    voice_id: '',
    name: '',
    description: '',
    preview_url: ''
  ...
  return (
      ...
      <T.Wrapper>
            ...
            <div style={{ width: '100%', visibility: isLoading ? 'hidden' : 'visible'}}>
              <T.Header>
                ...
                <T.HeaderDescription>
                  Add lifelike speech overlay to your LiveDemo using deep learning.
                </T.HeaderDescription>
              </T.Header>
              <T.Main>
                <T.ActionSelectorLine>
                  <T.ActionSelectorText>Select Voice Type:</T.ActionSelectorText>
              ...
              <T.Footer>
                ...
                >
                  ...
                  >
                    ...
                    }}>Voiceover with AI</T.ToolbarText>
                  </T.ToolbarButton>
                </T.FooterRightSide>
              </T.Footer>
            </div>
