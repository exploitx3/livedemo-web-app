...
import CheckoutView from '../../../../../components/CheckoutMobile/CheckoutView'
import ThreeDSecureView from '../../../../../components/Checkout/CheckoutViews/ThreeDSecureView'
...
const PaymentGateway = (props) => {
  ...
  const [userTopWorkspaceMember, setUserTopWorkspaceMember] = useState({})
  ...
  useEffect(() => {
    ...
    setUserTopWorkspaceMember(findTopWorkspaceMember(props.authData.workspaceMembers, props.selectedWorkspace))
