...
const CheckoutFailed = ({ changeBackStep, setShowTransition, setSelectWorkspaceSelected }) => {
  ...
  return (
    ...
    <Fragment>
      <S.Wrapper>
        ...
        <S.TopText>Payment Failed</S.TopText>
        <S.BottomText>Payment didn't go through</S.BottomText>
        ...
        <S.Button onClick={() => {
          ...
          changeBackStep()
          navigate('/billing', {state: {prevStep: STEPS.finalize, nextStep: STEPS.select}})
        }}>Go back</S.Button>
        {/*</div>*/}
      </S.Wrapper>
    </Fragment>
